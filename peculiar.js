...
function recize_notes() {
  for (let i = 0; i < notes.length; i++) {if (window.CP.shouldStopExecution(0)) break;
...
function notes_ready() {
  ...
  for (let i = 0; i < notes.length; i++) {if (window.CP.shouldStopExecution(1)) break;
    notes[i].addEventListener("click", function () {
      if (mobile_media_query.matches) {
        if (this.classList.contains("active")) {
          ...
          for (let i = 0; i < notes.length; i++) {if (window.CP.shouldStopExecution(2)) break;
            if (notes[i].classList.contains("active")) {
              notes[i].classList.remove("active");
              gsap.set(notes[i], {
                height: "30%",
        ...
        if (this.classList.contains("active")) {
          ...
          for (let i = 0; i < notes.length; i++) {if (window.CP.shouldStopExecution(3)) break;
            if (notes[i].classList.contains("active")) {
              notes[i].classList.remove("active");
              gsap.set(notes[i], {
                height: "30%",
        ...
        if (this.classList.contains("active")) {
          ...
          for (let i = 0; i < notes.length; i++) {if (window.CP.shouldStopExecution(4)) break;
            if (notes[i].classList.contains("active")) {
              notes[i].classList.remove("active");
              gsap.set(notes[i], {
                height: "30%",
